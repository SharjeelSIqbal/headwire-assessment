const GridCenter = ({ background }) => (
  <div className='grid-center column-center'>
    <div className='grid-center-container column-center'>
      <h1 className='grid-center-heading white-text titillium-light'>Best Furniture and Decor</h1>
    ...
    <div className='grid-absolute-center-content'>
      <svg  className='text-svg row-center' viewBox='0 0 250 80' xmlns='http://www.w3.org/2000/svg'>
        <text x='45' y='30' textLength='168' className='background-new'>
          {background}
        </text>
      </svg>
    </div>
